...
uniform vec3 g_TintColor; // {"default":"0 1 1","label":"ui_editor_properties_color","material":"color","type":"color"}
...
void main() {
	...
	albedo.rgb = ApplyBlending(BLENDMODE, albedo.rgb, vec3(0, 1, 1), mask);
